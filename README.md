...
| `ObjectiveWeights` | `[.15 .15 .10 .60]` | detail, information, contrast, preservation |
...
Selected CI results (mean across five seeds for PSO methods):

| Sample | Method | Entropy ↑ | Avg. gradient ↑ | Clipping ↓ | NIQE ↓ | PSNR ↑ | SSIM ↑ | Time, s ↓ |
|---|---|---:|---:|---:|---:|---:|---:|---:|
| Urban dusk | Original | 4.890 | 0.076 | 0.338 | 2.485 | — | — | 0.003 |
| Urban dusk | CLAHE | 5.146 | 0.167 | 0.000 | 2.935 | — | — | 0.305 |
| Urban dusk | PSO weighted | 6.514 | 0.200 | 0.265 | 2.607 | — | — | 1.599 |
| Urban dusk | PSO Pareto | 6.531 | 0.201 | 0.265 | 2.713 | — | — | 1.495 |
| Uneven light | Original | 6.575 | 0.068 | 0.036 | 2.154 | 6.125 | 0.459 | 0.003 |
| Uneven light | CLAHE | 7.228 | 0.161 | 0.000 | 1.877 | 8.225 | 0.670 | 0.360 |
| Uneven light | PSO weighted | 7.801 | 0.161 | 0.020 | 2.731 | 15.431 | 0.847 | 2.319 |
| Uneven light | PSO Pareto | 7.828 | 0.160 | 0.020 | 2.455 | 15.413 | 0.846 | 2.346 |

These numbers are not a universal ranking: for example, CLAHE wins NIQE on
the uneven-light case, while PSO better preserves the retained reference
according to PSNR and SSIM. Full means, standard deviations, and per-seed
runs are committed in [`benchmark-results/`](benchmark-results/).
<!-- BENCHMARK_TABLE_END -->
